...
# First plot 
plot(as.POSIXct(sample_data[,"DateTime"]), sample_data[,"Global_active_power"], type="l", ylab="Global Active Power", xlab="") 

# Second plot 
plot(as.POSIXct(sample_data[,"DateTime"]), sample_data[,"Voltage"], type="l", ylab="Voltage", xlab="datetime") 

# Third plot 
plot(as.POSIXct(sample_data[,"DateTime"]), sample_data[,"Sub_metering_1"], type="l", xlab="", ylab="Energy sub metering") 
...
# Fourth plot 
plot(as.POSIXct(sample_data[,"DateTime"]), sample_data[,"Global_reactive_power"], type="l", ylab="Global_reactive_power", xlab="datetime") 
